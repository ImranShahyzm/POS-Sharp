    ...
    public class LoginDAL
    {
        public DataTable SaveForm(LogInCommon obj )
        {
                ...
                if(CheckIFStoreWiseRights())
            {
                ...
                SqlCommand cmd;
                cmd = new SqlCommand(@"select CounterPCName,CounterTitle, ISNULL(ShopUserType,0) as ShopUserType,InventWareHouse.BranchID,GLUser.Userid,GLUser.UserPassword,GLUser.UserName,GLCompany.*,gen_PosConfiguration.WHID,gen_PosConfiguration.FiscalID,InventWareHouse.WHDesc as WareHouseName,gen_PosConfiguration.LocationID,gen_PosConfiguration.IsKhaakiSoft,gen_PosConfiguration.PosStyle,CounterID,
