...
/****** Object:  StoredProcedure [dbo].[PosApi_AllInevntory_Insert]    Script Date: 5/4/2021 10:32:09 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[POSAPI_InventItems]    Script Date: 5/4/2021 10:32:09 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[InventUOM]    Script Date: 5/4/2021 10:32:09 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[InventItemGroup]    Script Date: 5/4/2021 10:32:09 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[InventCategory]    Script Date: 5/4/2021 10:32:09 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemVariantInfo]    Script Date: 5/4/2021 10:32:09 AM ******/
IF  EXISTS (SELECT * FROM sys.types st JOIN sys.schemas ss ON st.schema_id = ss.schema_id WHERE st.name = N'gen_ItemVariantInfo' AND ss.name = N'dbo')
DROP TYPE [dbo].[gen_ItemVariantInfo]
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemSubCategoryInfo]    Script Date: 5/4/2021 10:32:09 AM ******/
IF  EXISTS (SELECT * FROM sys.types st JOIN sys.schemas ss ON st.schema_id = ss.schema_id WHERE st.name = N'gen_ItemSubCategoryInfo' AND ss.name = N'dbo')
DROP TYPE [dbo].[gen_ItemSubCategoryInfo]
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemMainGroupInfo]    Script Date: 5/4/2021 10:32:09 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemAttributeInfo]    Script Date: 5/4/2021 10:32:09 AM ******/
IF  EXISTS (SELECT * FROM sys.types st JOIN sys.schemas ss ON st.schema_id = ss.schema_id WHERE st.name = N'gen_ItemAttributeInfo' AND ss.name = N'dbo')
DROP TYPE [dbo].[gen_ItemAttributeInfo]
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemAttributeInfo]    Script Date: 5/4/2021 10:32:09 AM ******/
IF NOT EXISTS (SELECT * FROM sys.types st JOIN sys.schemas ss ON st.schema_id = ss.schema_id WHERE st.name = N'gen_ItemAttributeInfo' AND ss.name = N'dbo')
CREATE TYPE [dbo].[gen_ItemAttributeInfo] AS TABLE(
...
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemMainGroupInfo]    Script Date: 5/4/2021 10:32:10 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemSubCategoryInfo]    Script Date: 5/4/2021 10:32:10 AM ******/
IF NOT EXISTS (SELECT * FROM sys.types st JOIN sys.schemas ss ON st.schema_id = ss.schema_id WHERE st.name = N'gen_ItemSubCategoryInfo' AND ss.name = N'dbo')
CREATE TYPE [dbo].[gen_ItemSubCategoryInfo] AS TABLE(
...
GO
/****** Object:  UserDefinedTableType [dbo].[gen_ItemVariantInfo]    Script Date: 5/4/2021 10:32:10 AM ******/
IF NOT EXISTS (SELECT * FROM sys.types st JOIN sys.schemas ss ON st.schema_id = ss.schema_id WHERE st.name = N'gen_ItemVariantInfo' AND ss.name = N'dbo')
...
GO
/****** Object:  UserDefinedTableType [dbo].[InventCategory]    Script Date: 5/4/2021 10:32:10 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[InventItemGroup]    Script Date: 5/4/2021 10:32:10 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[InventUOM]    Script Date: 5/4/2021 10:32:10 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[POSAPI_InventItems]    Script Date: 5/4/2021 10:32:10 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[PosApi_AllInevntory_Insert]    Script Date: 5/4/2021 10:32:10 AM ******/
SET ANSI_NULLS ON
GO
