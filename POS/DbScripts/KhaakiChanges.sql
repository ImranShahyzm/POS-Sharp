...
/****** Object:  StoredProcedure [dbo].[data_SalePosReturnInfo_Insert]    Script Date: 4/22/2021 11:35:24 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[data_SalePosInfo_SelectAll]    Script Date: 4/22/2021 11:35:24 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[data_SalePosInfo_Insert]    Script Date: 4/22/2021 11:35:24 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[data_SalePosDetail]    Script Date: 4/22/2021 11:35:24 AM ******/
...
declare @RowID int,@SaleDetailID int ,@StockRate numeric(14,5) , @Quantity numeric(10,2),@ItemId int,@stockQty numeric(14,2),@ItemName varchar(200),@ERRORMSG varchar(200),
		@MainTainInventory bit = 1,@DealCateGoryID int=0,@ItemCategoryID int=0,@BomId int,
        @data_ManufacturingDetail  data_ManufacturingDetail  ,
        @data_ItemBatchDetail  data_ItemBatchDetail  ,
        @data_ItemBatchDetailFinish  data_ItemBatchDetail ,@ManufacturingID int=0
