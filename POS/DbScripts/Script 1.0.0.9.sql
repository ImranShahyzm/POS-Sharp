...
BEGIN TRANSACTION
GO
ALTER TABLE data_SalePosReturnInfo ADD
	MenuId int NULL,
	InvoiceType int NULL
GO
ALTER TABLE data_SalePosReturnInfo SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
...
/****** Object:  StoredProcedure [dbo].[data_SalePosReturnInfo_Insert]    Script Date: 4/30/2021 11:17:23 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[data_SalePosInfo_SelectAll]    Script Date: 4/30/2021 11:17:23 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[data_SalePosInfo_Insert]    Script Date: 4/30/2021 11:17:23 AM ******/
...
/****** Object:  StoredProcedure [dbo].[GetVoucherNoPos]    Script Date: 4/30/2021 11:02:29 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[GetVoucherNoPosFoodMama] 
...
Select @ClosingType=ClosingType from gen_PosConfiguration where CompanyID=@companyID
	...
	if @MenuID>0
	begin
	set @WC += ' and ' + @MenuFieldName + ' = ' + CONVERT(varchar(6), @MenuID)
	end
