...
/****** Object:  StoredProcedure [dbo].[data_SalePosInfo_Insert]    Script Date: 9/1/2021 2:05:18 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[data_SalePosInfo_SelectAll]    Script Date: 9/1/2021 2:29:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
if @ReturnSaleID!=0 
	begin
		...
		print @whereClause
		exec('select *,b.SalePOSNo as LinkedBillNo from data_SalePosInfo left join data_SalePosInfo b on b.LinckedBill=data_SalePosInfo.SalePosID '+ @WhereClause)
...
/****** Object:  StoredProcedure [dbo].[data_SalePosInfo_SelectAll]    Script Date: 9/1/2021 2:45:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
