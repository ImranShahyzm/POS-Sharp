...
namespace POS
{
    public partial class frmCustomerDataFoodMama : MetroForm
    {
        ...
        private void frmCustomerDataFoodMama_Load(object sender, EventArgs e)
        {
            txtCustomerName.Focus();
        }
        ...
        private void frmCustomerDataFoodMama_KeyDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode==Keys.Escape)
            {
                KhaakiObjet.AllowSave = false;
