...
{
    public partial class FrmDispatchTransferDetailForm :MetroForm
    {
        public FrmDispatchTransferDetailForm(int id,string ArrivalNo="")
        {
            InitializeComponent();
        ...
        public void setGriddataAsync(int id)
        {
            ...
            var dt = obj.SelectAllRemainigDispatchTransferDetail(" where data_StockDispatchAgainstTransferPOS.StockTransferID=" + id+ " and data_StockDispatchAgainstTransferPOS.CompanyID=" + CompanyInfo.CompanyID+ " and DispatchToWhid=" + CompanyInfo.WareHouseID, "").Tables[0];
            ...
            dgvStockDetailData.Columns["DispatchToWhid"].Visible = false;
            dgvStockDetailData.Columns["TransferDetailID"].Visible = false;
