...
namespace POS
{
    public partial class frmCreditCardDetailsMake : MetroForm
    {
        public string CardNumber { get; set; }
        public string CardName { get; set; }
        public frmMakeToOrder KhaakiObjet;
        public frmCreditCardDetailsMake(frmMakeToOrder obj)
        {
            InitializeComponent();
            //loadCashSource();
            KhaakiObjet = obj;
        ...
        private void frmCreditCardDetailsMake_Load(object sender, EventArgs e)
        {
            txtCardNumber.Focus();
        }
        ...
        private void frmCreditCardDetailsMake_KeyDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode==Keys.Escape)
            {
                this.Close();
