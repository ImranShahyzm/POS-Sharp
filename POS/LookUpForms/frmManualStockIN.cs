...
{
    public partial class frmManualStockIN : MetroForm
    {
        public frmManualStockIN()
        {
            InitializeComponent();
            loadProducts();
            getArrivalNo();
        ...
        private void frmManualStockIN_Load(object sender, EventArgs e)
        {
            getArrivalNo();
        ...
        private DataTable GetdataTableFromGrid()
        {
            ...
            foreach (DataGridViewRow row in dgvStockInDetail.Rows)
            {
                ...
                dt.Rows[dt.Rows.Count - 1][2] = row.Cells[1].Value.ToString();
                dt.Rows[dt.Rows.Count - 1][3] = row.Cells[2].Value.ToString();
                dt.Rows[dt.Rows.Count - 1][4] = row.Cells[3].Value.ToString();
                dt.Rows[dt.Rows.Count - 1][5] = row.Cells[4].Value.ToString();
            ...
            if (ArrivalID > 0)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach(DataRow row in dt.Rows)
                    {
                        ...
                        txtManualNo.Text = row[4].ToString();
