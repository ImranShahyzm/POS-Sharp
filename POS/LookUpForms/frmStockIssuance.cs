...
namespace POS.LookUpForms
{
    public partial class frmStockIssuance : MetroForm
    {
        public frmStockIssuance()
        {
            ...
            cmbIssuanceType.Items.Insert(2, "Return to HeadOffice");
        ...
        public void getIssuanceNo()
        {
            ...
            cmbIssuanceType.Select();
            cmbIssuanceType.Focus();
        }
        ...
        private void AddProducts( int id)
        {
            ...
            //        string value = dgvStockInDetail.Rows[i].Cells[2].Value.ToString();
                   
                   
            //        string rateValue = dgvStockInDetail.Rows[i].Cells[3].Value.ToString();
            //        decimal rate = Convert.ToDecimal(rateValue);
            //        decimal qty = Convert.ToDecimal(value);
            //        qty++;

            //        dgvStockInDetail.Rows[i].Cells[2].Value = qty;
            //        dgvStockInDetail.Rows[i].Cells[4].Value = ( qty * rate);
        ...
        private DataTable GetdataTableFromGrid()
        {
            ...
            foreach (DataGridViewRow row in dgvStockInDetail.Rows)
            {
                ...
                dt.Rows[dt.Rows.Count - 1][3] = row.Cells[2].Value.ToString();
                dt.Rows[dt.Rows.Count - 1][4] = row.Cells[3].Value.ToString();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                model.IssuanceType = cmbIssuanceType.SelectedIndex;
            ...
            if (IssuanceID > 0)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach(DataRow row in dt.Rows)
                    {
                        ...
                        cmbIssuanceType.SelectedIndex= Convert.ToInt32(row[8].ToString());
        ...
        private void frmStockIssuance_KeyDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode==Keys.Enter)
            {
                if (dgvStockInDetail.CurrentRow != null)
