...
namespace POS
{
    public partial class frmDailySaleReturn : MetroForm
    {
        public frmDailySaleReturn()
        {
            InitializeComponent();
            laodCategories();
            loadSaleMenuGroup();
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            using (frmCrystal obj = new frmCrystal())
            {
                string reportName = "";
                string WhereClause = "";
                reportName = "Sale Return Report";
                //  WhereClause = " Cash Book Detail From " + dtpSaleFromDate.Text + " To " + dtpSaleToDate.Text + "";
                try
                {
                    obj.rptDailySaleReturn(reportName, dtpSaleFromDate.Value, dtpSaleToDate.Value,Convert.ToInt32(cmbCategory.SelectedValue), Convert.ToInt32(cmbSalemenu.SelectedValue));
        ...
        private void frmDailySaleReturn_Load(object sender, EventArgs e)
        {
