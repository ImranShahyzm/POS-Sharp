...
namespace POS
{
    public partial class frmDailySaleManWise : MetroForm
    {
        public frmDailySaleManWise()
        {
            InitializeComponent();
            laodCategories();
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            using (frmCrystal obj = new frmCrystal())
            {
                ...
                try
                {
                    obj.rptSalesManWise(reportName, dtpSaleFromDate.Value, dtpSaleToDate.Value,Convert.ToInt32(cmbCategory.SelectedValue), Convert.ToInt32(cmbSalesMan.SelectedValue), Convert.ToInt32(cmbSaleStyle.SelectedValue));
        ...
        private void frmDailySaleManWise_Load(object sender, EventArgs e)
        {
            ...
            var items = new[] 
                {
                    new { Text = "Detail Report", Value = "1" },
                    new { Text = "Cash and Credit Wise", Value = "2" }
